...
Extended Oracle Packaged - JET-CommonModel-CRUD.
Added -
  restServer using express w/ express routes for GET, PUT, DELETE, Repositories
  restServer / server.js uses mongo, mongoose
